...
func NewWithOptions(name types.AgentName, bin string, extraArgs []string, opts Options) (Agent, error) {
	...
	case types.AgentClaude:
		return &claudeAgent{bin: bin, extraArgs: extraArgs, envOverrides: opts.EnvOverrides, disableProjectSettings: opts.DisableProjectSettings}, nil
	case types.AgentCodex:
		return &codexAgent{bin: bin, extraArgs: extraArgs, envOverrides: opts.EnvOverrides, disableProjectSettings: opts.DisableProjectSettings}, nil
	...
	case types.AgentPi:
		return &piAgent{bin: bin, extraArgs: extraArgs, envOverrides: opts.EnvOverrides, disableProjectSettings: opts.DisableProjectSettings}, nil
